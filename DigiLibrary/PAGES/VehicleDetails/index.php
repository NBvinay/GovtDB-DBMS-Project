<?php
  ...
  if(isset($_POST['submit']))
  {
      ...
      { 
        // $count = $count +1;
        if (!($dlno== NULL || $num[$key]== NULL || $regno[$key]== NULL || $insno[$key]== NULL || $adharNumber==NULL))
        {
         
          // Nigga Change acc to db
		  //mysqli_query($con , "INSERT INTO `vehicle_details` (`Aadhar Number`, `WheelNumber`, `Registration Number`, `DL Number`, `Insurance Number`) VALUES ('$adharNumber', '$num', '$regno[$key]', '$dlno', '$insno[$key]');");
          $flag = 0;
      ...
      <div class="tab-content">   
          ...
          <form action="/" method="post">
				...
				<div class="field-wrap">
                              ...
                              <input type="text"required autocomplete="off" name="dlno"/>
                </div>
                ...
                <div class="input_fields_wrap">    
                   <div>
                         ...
                         <div class="field-wrap">
                              ...
                              <input type="text"required autocomplete="off" name="num[]"/>
                        </div>
                        ...
                        <div class="field-wrap">
                              ...
                              <input type="text"required autocomplete="off" id="regno[]"name="regno[]"/>
                        </div>
