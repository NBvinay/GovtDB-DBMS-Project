  ...
  if(isset($_POST['submit']))
  {
      ...
      { 
        ...
        if (!($propCount== NULL || $katha[$key]== NULL || $city[$key]== NULL || $postalAddress[$key]== NULL || $adharNumber==NULL))
        {
		  ...
		  //mysqli_query($con , "UPDATE INTO `vehicle_details` (`Aadhar Number`, `WheelNumber`, `Registration Number`, `DL Number`, `Insurance Number`) VALUES ('$adharNumber', '$propCount', '$katha[$key]', '$city[$key]', '$postalAddress[$key]');");
          $flag = 0;
